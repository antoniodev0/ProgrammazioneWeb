...
$sql = "SELECT * FROM ricette WHERE categoria = 'Dolci'";
...
<body>
    ...
    <div class="login-registrazione" id="loginSection">
        ...
        <header>
        <?php if ($logged_in){ echo '<a href="Dashboard_utente.php"><h1>FooD Day - Dolci</h1></a>';}
                else{ echo '<a href="homepage.php"><h1>FooD Day - Dolci</h1></a>';}?>
            <p>Benvenuti nella sezione dei Dolci!</p>
        </header>
        <nav>
            <ul>
        ...
        <section id="ricette-dolci">
            <h2>Ricette di Dolci</h2>
            ...
            <?php if ($results->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p>Non ci sono ricette di Dolci al momento.</p>
            <?php endif; ?>
        </section>
    </div>
